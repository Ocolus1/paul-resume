...
export default function SectionOne({ myExpertise }) {
  return (
    <div className="flex justify-center text-white" ref={myExpertise}>
      <div className="py-16">
        <h1 className="text-7xl font-bold text-center mb-10" >My Expertise</h1>
        ...
        <div className="flex flex-row justify-center">
            <div className="" style={{marginTop: "-1.5rem"}}>
                <img src="https://tamalsen.dev/wp-content/uploads/2021/12/hello-world-html-code-768x384.png" className="opacity-25" alt="code " />
            </div>
        </div>
      </div>
    </div>
