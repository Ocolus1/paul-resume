...
export default function Hero({ scrollToExpertise, myHome }) {
  ...
  return (
    <div className="max-h-dvh py-10 lg:py-0 lg:min-h-dvh flex justify-center" ref={myHome} >
      <div className="text-white text-center pt-12 sm:pt-28 md:pt-32 lg:pt-48">
        ...
        <h3 className="smw:text-xs md:text-xl lg:text-2xl mb-12" >SOFTWARE ENGINEER, FRONT END & BACK END.</h3>
